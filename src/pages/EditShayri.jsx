...
import { Edit3, Send, User, Tag, BookOpen, ArrowLeft, Loader } from 'lucide-react';
...
const EditShayri = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMsg = error.response?.data?.message || 'Failed to update Shayri';
      ...
      >
        ...
        <div className="glass rounded-[2.5rem] p-8 md:p-12 shadow-2xl border border-white/20">
          <div className="flex items-center space-x-4 mb-10">
            ...
            <div>
              <h2 className="text-3xl font-black text-slate-900 tracking-tight">Edit <span className="text-blue-600">Shayri</span></h2>
              <p className="text-slate-500 font-bold text-xs uppercase tracking-widest mt-1">Refining the Literature</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                placeholder="Modify the beautiful verses here..."
              ...
              <div className="space-y-3">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute right-5 top-1/2 -translate-y-1/2 pointer-events-none text-slate-400 group-hover:text-blue-600 transition-colors">
                    <Edit3 className="w-4 h-4 rotate-45" />
                  </div>
                </div>
              </div>
