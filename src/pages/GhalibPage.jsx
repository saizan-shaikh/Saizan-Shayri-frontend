...
const GhalibPage = () => {
  ...
  const fetchShayris = async () => {
    ...
    try {
      ...
      // 5. Update State (Single Source of Truth)
  ...
  const adviceConfig = {
    ...
    verses: [
      { text: "Aadmi ko bhi mayassar nahi insaan hona.", subtext: "True humanity is the ultimate pursuit" },
      { text: "Dard minnat-kash-e-dawa na hua.", subtext: "Finding strength within the struggle" }
    ],
    gradient: "from-blue-600 via-indigo-500 to-cyan-400",
    themeColor: "text-blue-600",
    tagLine: "The Mirza Ghalib Legacy"
  };
